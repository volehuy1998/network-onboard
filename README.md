...
- [2.9 - Quản lý tệp đóng gói và nén với công cụ `tar` ( :arrow_up: UPDATED 13/01/2024)](https://github.com/volehuy1998/network-onboard/blob/master/linux-onboard/2.9%20-%20linux-manage-compressed-tar-archives.md#manage_compress_tar_archive)
    - 2.9.1 - Tạo và quản lý tệp đóng gói ( :arrow_up: UPDATED 13/01/2024)
    - 2.9.2 - Tạo và quản lý tệp nén đóng gói ( :arrow_up: UPDATED 13/01/2024)
    - 2.9.3 - Quản lý tệp sao lưu gia tăng `incremental backup` ( :heavy_plus_sign: UPDATED 13/01/2024)
    - 2.9.4 - Chuyển tệp giữa các hệ thống một cách an toàn ( :heavy_plus_sign: UPDATED 07/01/2024)
    - 2.9.5 - Đồng bộ giữa các hệ thống một cách an toàn ( :heavy_plus_sign: UPDATED 07/01/2024)