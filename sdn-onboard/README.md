...
- Phần 4.4, [OpenFlow 1.5, egress tables, L4-L7](4.4%20-%20openflow-1.5-egress-l4l7.md) *(skeleton)*, egress pipeline, gói tin type aware, TCP flags match.
...
- Phần 4.7, [OpenFlow programming với ovs-ofctl](4.7%20-%20openflow-programming-with-ovs.md) *(content, cross-cutting OpenFlow → OVS)*, multi-table pipeline hands-on, conntrack integration, flow hygiene playbook, cầu nối Khối IV lý thuyết sang Khối IX thực hành.
