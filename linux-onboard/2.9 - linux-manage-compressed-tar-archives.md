...
- [2.9 - Quản lý tệp sao lưu và nén với công cụ `tar` ( :arrow_up: UPDATED 13/01/2024)](#manage_compress_tar_archive)
    ...
    - [2.9.2 - Tạo và quản lý tệp nén sao lưu ( :heavy_plus_sign: UPDATED 13/01/2024)](#manage_compressed_file)
...
Lệnh sau sẽ tạo ra tệp sao lưu `mybackup.tar` chứa các tệp nhật ký `*.log`. Nếu tệp sao lưu đã có thì sẽ bị ghi đè.
