...
**5. Liên hệ concept.** Nối output với cơ chế đã học. Ví dụ: `packets`/`bytes` counter trong `ofproto/trace` không tăng cho đến khi có `-generate`, vì đây là simulation không gửi packet thật — kết nối với Phần 9.2 §9.2.X fast/slow path.
