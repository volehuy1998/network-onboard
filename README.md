...
- [2.9 - Quản lý tệp đóng gói và nén với công cụ `tar` ( :heavy_plus_sign: UPDATED 07/01/2024)](https://github.com/volehuy1998/network-onboard/blob/master/linux-onboard/2.9%20-%20linux-manage-compressed-tar-archives.md#manage_compress_tar_archive)
