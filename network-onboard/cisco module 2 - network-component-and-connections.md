...
- [2.0 - Vai trò máy khách và máy chủ](#server_client_role)
...
- [2.1 - Các thành phần trong mạng](#network_component)
    - [2.1.1 - Hạ tầng mạng](#network_infra)
    - [2.1.2 - Thiết bị cuối](#end_dev)
    - [2.1.3 - Thiết bị trung gian](#intermediary_net_dev)
- [2.2 - LAN và WAN](#lan_wan)
- [2.3 - Internet](#internet)
- [2.4 - ISP](#isp)
    - [2.4.1 - Dịch vụ ISP](#isp_service)
    - [2.4.2 - Kết nối ISP](#isp_connection)
    - [2.4.3 - Công nghệ truy cập Internet](#internet_access_technologies)
    - [2.4.3 - Kết nối bổ sung](#add_connection)
