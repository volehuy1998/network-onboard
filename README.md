...
- [2.7 - Kiến trúc nhật ký hệ thống (UPDATED 06/12/2023)](https://github.com/volehuy1998/network-onboard/blob/master/linux-onboard/2.7%20-%20linux-system-log-architecture-overview.md#sys_log_arch)
  ...
  - 2.7.2 - Cách sử dụng `rsyslog` ( :add: UPDATED 06/12/2023)
  - 2.7.3 - Cách sử dụng `systemd-journald` ( :wrench: UPDATED 10/12/2023)
  - 2.7.4 - Đồng bộ thời gian (UPDATED 10/12/2023)
    - 2.7.4.1 - Tổng quan `Network Time Protocol` (UPDATED 10/12/2023)
    - 2.7.4.2 - Công cụ `datetimectl` (UPDATED 10/12/2023)
    - 2.7.4.3 - Cấu hình `NTP` sử dụng `chrony` (UPDATED 10/12/2023)
