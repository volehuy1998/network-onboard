...
- [2.8 - Lập lịch chạy cho tác vụ tương lai ( :arrow_up: UPDATED 01/01/2023)](#schedule_job)
  ...
  - [2.8.4 - Ứng dụng `systemd timer` ( :heavy_plus_sign: UPDATED 01/01/2023)](#systemd_timer)
    - [2.8.4.1 - Cách sử dụng công cụ `systemd timer` ( :heavy_plus_sign: UPDATED 01/01/2023)](#systemd_timer_basic)
    - [2.8.4.2 - Quản lý loại tệp tạm thời ( :heavy_plus_sign: UPDATED 01/01/2023)](#manage_tmp_file)
      - [2.8.4.2.1 - Cách sử dụng `systemd-tmpfiles --create` ( :heavy_plus_sign: UPDATED 01/01/2023)](#tmpfiles_create)
      - [2.8.4.2.2 - Cách sử dụng `systemd-tmpfiles --clean` ( :heavy_plus_sign: UPDATED 01/01/2023)](#tmpfiles_clean)
      - [2.8.4.2.3 - Cách sử dụng `systemd-tmpfiles --remove` ( :heavy_plus_sign: UPDATED 01/01/2023)](#tmpfiles_remove)
