...
- [2.7 - Kiến trúc nhật ký hệ thống ( :white_check_mark: UPDATED 12/12/2023)](#sys_log_arch)
  ...
  - [2.7.4 - Đồng bộ thời gian ( :white_check_mark: UPDATED 12/12/2023)](#clock_time)
    - [2.7.4.1 - Tổng quan `Network Time Protocol` ( :white_check_mark: UPDATED 12/12/2023)](#ntp)
...
- <u>Bước 4</u>: Máy khách tự xác định thời điểm thông qua 2 quy tắc, loại bỏ thời gian trì hoãn tại máy chủ và chỉ lấy khoảng thời gian trên đoạn đường 1 chiều. 
  ...
  - Phép toán phụ: lấy thời điểm thật `B2+2(minutes) = 14:03 (minutes)`.
  - Phép toán phụ: đồng hồ tại máy khách cần `+58 (minutes)` để có được thời điểm `14:03 (PM)` của máy chủ "vừa trải qua". 
