...
| 4.9 openflow-action-catalog | PARTIAL | Header through §4.9.33.9 translated across nine commits (72ef39d, 80389b3, 6ccf0f1, 44a9fa0, ebc28ef, 73f6e4e, 1565120, fe0ded3). About 271 of 419 prose chunks now English, 65 percent migration progress. Sections English: §4.9.1 foundation, §4.9.2-§4.9.16 Category 1+2 (Output, Encap-Decap, MPLS, PBB, NSH), §4.9.17-§4.9.21 Category 3+4+7 (set_field, mod_*, dec_ttl, move/load, write_metadata, set_tunnel, set_queue, enqueue, meter), §4.9.22 aggregate tier table, §4.9.23-§4.9.24 ct/learn, §4.9.25-§4.9.28 conjunction/multipath/bundle/check_pkt_larger, §4.9.29 v3.5 backfill (12 actions), §4.9.30 source-code citation, §4.9.31 v3.6 NXM stack/timeout backfill, §4.9.32 output cornerstone deep-dive, §4.9.33.1-§4.9.33.9 mid-tier modification cornerstones (drop, set_field, mod_dl_src/dst, dec_ttl, mod_nw_src/dst, mod_tp_src/dst). Remaining (about 148 chunks): §4.9.33.10 onward (additional cornerstones if any), §4.9.34 cross-reference outer-tier group, §4.9.35-§4.9.37 peripheral action treatments (5 MPLS+PBB, 5 NSH+observability, 5 NXM stack+register), §4.9.37.6 source-code citation. |
