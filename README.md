...
- 2.7 - Điều khiển an toàn từ xa (:arrow_up:UPDATED 22/10/2023)
  ...
  - 2.7.2 - Cài đặt `OpenSSH`, kết nối và cấu hình (:arrow_up:UPDATED 22/10/2023)
    ...
    - 2.7.2.3 - Cấu hình `ssh client` (:arrow_up:UPDATED 21/10/2023)