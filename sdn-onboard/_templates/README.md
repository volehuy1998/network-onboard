...
> **Mục đích:** đảm bảo mọi Part trong Phase H (Foundation Depth Pass) viết content theo 4 template chuẩn thay vì ad-hoc.
...
|---|---|---|---|
| A | [Anatomy block](template-a-anatomy-block.md) | Giải thích output của một command (dump-flows, show, trace, stats) | OVS Advanced Tutorial field annotation |
