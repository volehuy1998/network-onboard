...
| Architecture backlog (**rev 3 scope tightening 2026-04-21**) | Phase P0 DONE (9 file scope-out gồm XIV 4 + XV 2 + XVI 2 + 6.2 IBN — đã `git rm` + 5 file scrubbed). Phase P1-P5 pending: P1 Block XIII expansion 13.4/13.5/13.6 absorb từ XIV; P2 Block IX expansion 9.6-9.14 absorb Compass Part II; P3 add 4.7 OF programming + 10.2 OVSDB ops + 11.3 GRE lab + 11.4 IPsec lab; P4 refine Block V/VI/VII/VIII/XII Rule 10; P5 end-to-end review. Tổng sau rev 3 ≈ 66 file (từ 60 cũ - 9 xóa + 15 thêm). Plan chi tiết: `.claude/plans/flickering-baking-fern.md`. |
