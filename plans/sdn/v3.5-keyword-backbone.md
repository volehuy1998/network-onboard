...
- **Rule 2 (Cross-File Sync):** mỗi commit check `memory/shared/file-dependency-map.md`; thêm file mới sẽ update map sau J.7.
- **Rule 6 Checklist B + C + E:** mỗi sub-phase chạy đầy đủ.
- **Rule 11:** §11.6 sweep cuối mỗi sub-phase. Dictionary `memory/shared/rule-11-dictionary.md` updated nếu phát hiện new prose word.
