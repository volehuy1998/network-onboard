...
| Key | Value |
|-----|-------|
| Branch | `docs/sdn-foundation-rev2`. Latest tag: `v4.1.0-OVNBlockHotfix` (2026-04-28 local, plan v3.10 full closure). Prior tags: `v4.0-MasteryComplete` (2026-04-26 local), `v4.0.1-OVSHotfix` (2026-04-27 local, plan v3.9 close), `v4.0.3-OVSComprehensiveResolution` (2026-04-28 local, plan v3.9.4 close). **No remote push per system policy.** |
| Curriculum | About 128 files in `sdn-onboard/*.md`, about 96,000 lines, 20 blocks. All v3.8 R0 to R6, v3.9 OVS block hotfix S0 to S8, v3.9.1 to v3.9.4 OVS resolution chain, and v3.10 OVN block hotfix complete. OVS scope (Block 9, 10, 20.0, 20.1) and OVN scope (Block 13, 17, 18, 19, OVN-relevant subsections of Block 20): zero rubric leak. Non-OVS / non-OVN scope (Block 3, Block 4, README, templates): 15 leaks remaining, deferred to v3.11 and a cross-block plan. |
| Active phase | **None. Plan v3.10 closed 2026-04-28 with tag `v4.1.0-OVNBlockHotfix`.** Next planned: v3.11 (OF block hotfix), then a cross-block README + templates plan, then v3.12 (curriculum-wide English migration). |
