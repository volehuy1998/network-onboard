...
- 2.6 - Tổng quan tiến trình Linux (:arrow_up:UPDATED 28/09/2023)
    - 2.6.1 - Trạng thái của tiến trình Linux (:arrow_up:UPDATED 17/09/2023)
    - 2.6.2 - Kiểm soát các `Job` (:arrow_up:UPDATED 17/09/2023)
    - 2.6.3 - Kết thúc tiến trình (:arrow_up:UPDATED 18/09/2023)
    - 2.6.4 - Dịch vụ hạ tầng (:arrow_up:UPDATED 21/09/2023)
    - 2.6.5 - Tổng quan về `systemd` (:arrow_up:UPDATED 19/09/2023)
    - 2.6.6 - Xác định tiến trình hệ thống tự khởi chạy (:arrow_up:UPDATED 22/09/2023)
    - 2.6.7 - Kiểm soát dịch vụ hệ thống (:arrow_up:UPDATED 24/09/2023)
    - 2.6.8 - Chi tiết tệp `unit` (:heavy_plus_sign:UPDATED 28/09/2023)
        - 2.6.8.1 - Loại `unit` phổ biến `*.service` (:heavy_plus_sign:UPDATED 28/09/2023)
        - 2.6.8.2 - Loại `unit` về `*.socket` (:heavy_plus_sign:UPDATED 28/09/2023)
        - 2.6.8.3 - Loại `unit` về `*.path` (:heavy_plus_sign:UPDATED 28/09/2023)