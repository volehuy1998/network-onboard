- [2.12 - Quản lý lưu trữ nâng cao ( :heavy_plus_sign: UPDATED 07/02/2024)](#manage_advance_storage)
  ...
  - [2.12.2 - Xây dựng hệ thống lưu trữ LVM ( :heavy_plus_sign: UPDATED 07/02/2024)](#lvm_build)
  - [2.12.3 - Tạo Logical Volume tính năng nén và chống trùng lặp ( :heavy_plus_sign: UPDATED 07/02/2024)](#lvm_vdo)
  - [2.12.4 - Hiển thị thông tin trạng thái thành phần LVM ( :heavy_plus_sign: UPDATED 07/02/2024)](#lvm_info)
  - [2.12.5 - Mở rộng kích thước Logical Volume ( :heavy_plus_sign: UPDATED 07/02/2024)](#lvm_extend)
...
<i>Lưu ý: Chức năng VDO LVM của RHEL9.3 được kiểm tra lần cuối vào ngày 01/2024 đã phát hiện sự cố. Chức năng không hoạt động. Xem thêm thảo luận tại [Red Hat](https://access.redhat.com/discussions/7055345).</i>


### <a name="lvm_info">Hiển thị thông tin trạng thái thành phần LVM</a>
