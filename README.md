...
- 2.6 - Tổng quan tiến trình Linux (:arrow_up:UPDATED 01/10/2023)
    ...
    - 2.6.7 - Chi tiết tệp `unit` (:arrow_up:UPDATED 01/10/2023)
        - 2.6.7.1 - Loại `unit` phổ biến `*.service` (:arrow_up:UPDATED 01/10/2023)
        - 2.6.7.2 - Loại `unit` về `*.socket` (:arrow_up:UPDATED 30/09/2023)
        - 2.6.7.3 - Loại `unit` về `*.path` (:arrow_up:UPDATED 30/09/2023)