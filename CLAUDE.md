...
| Key | Value |
|-----|-------|
| Branch | `docs/sdn-foundation-rev2`. Latest commit: `1dbfe07` (R4 v3.11 CHANGELOG Reckoning #8, 2026-04-29). Latest tag: `v4.1.0-OVNBlockHotfix` (2026-04-28 local, plan v3.10 full closure). Plan v3.11 closed without a tag pending user sign-off per Rule 15. Prior tags: `v4.0-MasteryComplete`, `v4.0.1-OVSHotfix`, `v4.0.3-OVSComprehensiveResolution`. **No remote push per system policy.** |
| Curriculum | About 128 files in `sdn-onboard/*.md`, about 96,000 lines, 20 blocks. All v3.8 R0-R6, v3.9 OVS S0-S8, v3.9.1 to v3.9.4 OVS resolution chain, v3.10 OVN block hotfix, and v3.11 OF block hotfix complete. OVS scope (Block 9, 10, 20.0, 20.1), OVN scope (Block 13, 17, 18, 19, OVN-relevant subsections of Block 20), and OF scope (Block 3, Block 4): zero rubric leak. Cross-block scope (`README.md`, `_templates/template-d-per-table.md`): 3 leaks remaining, deferred to a cross-block plan. |
| Active phase | **None. Plan v3.11 closed 2026-04-29 (R0-R4 complete, R5 tag pending user sign-off).** Next planned: cross-block README + templates plan (~5-10 hours), then v3.12 (curriculum-wide English migration). |
