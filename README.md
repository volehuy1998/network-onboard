...
- 2.6 - Tổng quan tiến trình Linux (:arrow_up:UPDATED 21/09/2023)
    ...
    - 2.6.4 - Dịch vụ hạ tầng (:heavy_plus_sign:UPDATED 21/09/2023)
    - 2.6.5 - Tổng quan về `systemd` (:heavy_plus_sign:UPDATED 19/09/2023)
    - 2.6.6 - Tiến trình hệ thống tự khởi chạy (:heavy_plus_sign:UPDATED 21/09/2023)