...
- 2.6 - Tổng quan tiến trình Linux (:arrow_up:UPDATED 30/09/2023)
    ...
    - 2.6.6 - Kiểm soát dịch vụ hệ thống (:arrow_up:UPDATED 30/09/2023)
    - 2.6.7 - Chi tiết tệp `unit` (:heavy_plus_sign:UPDATED 30/09/2023)
        - 2.6.7.1 - Loại `unit` phổ biến `*.service` (:heavy_plus_sign:UPDATED 30/09/2023)
        - 2.6.7.2 - Loại `unit` về `*.socket` (:heavy_plus_sign:UPDATED 30/09/2023)
        - 2.6.7.3 - Loại `unit` về `*.path` (:heavy_plus_sign:UPDATED 30/09/2023)